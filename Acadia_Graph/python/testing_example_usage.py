...
def main():
    ...
    strategy = sampling_strategy.uniform({'N': 30, 'P': 3934, 'initial': 1, 'period': 3})

    print("Doing 10 days of testing")
    for i in range(0,10):
        print(strategy.sample(i))
    ...
    strategy = sampling_strategy.weighted({'N': 30, 'weights': weights, 'initial': 1, 'period': 3})
