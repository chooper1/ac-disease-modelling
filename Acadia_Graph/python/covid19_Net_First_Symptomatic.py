...
# syntax: [N,Cu,P,Ou,R0, R0T, Y, x, k] = covid19_Net(bet,tau,ph,init,Net,T,sigma)
#
...
#         k      time when first symptomatic case appears
#
...
def covid19_Net_First_Symptomatic(bet,tau,ph,init,NetGrouped,T,sigma,ndt,C_ind):
